...
Para executar este projeto, instale o Python, o PostgreSQL e a extensão PostGIS.  
Acesse o PostgreSQL, crie um banco de dados chamado sbdg_terremotos e execute o comando SQL abaixo:  
